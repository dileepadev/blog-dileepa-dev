...
> This post covers the concepts. If you want to actually build something, I've started a hands-on series called [Zero to Agent](/blog/2026-08-06-zero-to-agent-microsoft-foundry-series-kickoff) that walks through Foundry step by step, from your first project to a working agent.
